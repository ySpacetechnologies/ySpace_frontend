...
export function FuturePlans() {
  return (
    <section id="future-plans" className="relative flex scroll-mt-20 items-center overflow-hidden py-30 lg:py-40">
      ...
      <Container className="relative flex justify-center">
        <div className="flex max-w-239.5 flex-col items-center">
          ...
          <Link href="/technology" className="bg-action hover:bg-action-hover text-body-lg-m text-primary-50 md:text-body-lg mt-12 flex h-16 items-center justify-center rounded-sm px-6 font-medium transition-colors active:opacity-85">
            Learn More
          </Link>
        </div>
      </Container>
