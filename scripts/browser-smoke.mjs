...
// The sandbox roots screenshots at /workspace; a local checkout may live
// anywhere, so the project root is equally valid output.
const ALLOWED_ROOTS = ["/workspace", fileURLToPath(new URL("..", import.meta.url))];
